...
My research interests mainly lie in **Multi-modal Adaptive Agentic RL** and **Fine-grained Evaluation of Long-horizon Reasoning**. Particularly, I am interested in:

* **Multi-modal Adaptive Agentic RL**: Empower agents through reinforcement learning to autonomously interact with complex, dynamic environments and carry out multi-turn, long-horizon decision-making tasks, enabling them to better process text-image and video information.
